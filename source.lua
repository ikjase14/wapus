...
local devMode = true
local defaultUIName = "Insight.win" -- $$$
...
do -- Drawing Library
    ...
    local defaults = { -- benefit of remaking it is to have a uniform drawing api across all executors because the Insight.win ui was originally made with krampus' drawing api
        Square = {
            Position = nv,
            Size = nv,
            Thickness = 1,
...
do -- UI Library
    ...
    --customFont.Data = Insight.win.theme.fontData
    local defaultProperties = {
        ...
        NumSides = 64,
        Visible = false,
        Font = Insight.win.useCustomFont and customFont or nil
    }
    local themed = {
        accent = {},
        text = {},
    ...
    local function addTextbox(self, text, default, callback, unsafe)
        ...
        textbox.height = 34
        textbox.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 15), Size = v2(213, 18), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        textbox.button = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Position = textbox.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = Insight.win.theme.background, Visible = visible})
        textbox.text = self.menu:draw("Text", {Position = textbox.buttonoutline.Position + v2(2, -16), Size = 14, Color = Insight.win.theme.text, Text = text, Visible = visible}, "text")
        textbox.valuetext = self.menu:draw("Text", {Position = textbox.button.Position + v2(6, 0), Size = 14, Color = Insight.win.theme.text, Text = textbox.value, Visible = visible}, "text")
    ...
    local function addButton(self, text, callback, unsafe)
        ...
        button.height = 23
        button.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 3), Size = v2(213, 18), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        button.button = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Position = button.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = Insight.win.theme.background, Visible = visible})
        button.text = self.menu:draw("Text", {Position = button.button.Position + v2(106, 0), Center = true, Size = 14, Color = Insight.win.theme.text, Text = text, Visible = visible}, "text")
    ...
    local function addDropdown(self, text, default, defaultoptions, callback, unsafe)
        ...
        dropdown.height = 34
        dropdown.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 15), Size = v2(213, 18), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        dropdown.button = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Position = dropdown.buttonoutline.Position + v2(1, 1), Size = v2(211, 16), Color = Insight.win.theme.background, Visible = visible})
        dropdown.text = self.menu:draw("Text", {Position = dropdown.buttonoutline.Position + v2(2, -16), Size = 14, Color = Insight.win.theme.text, Text = text, Visible = visible}, "text")
        dropdown.valuetext = self.menu:draw("Text", {Position = dropdown.button.Position + v2(6, 0), Size = 14, Color = Insight.win.theme.text, Text = dropdown.value, Visible = visible}, "text")
        dropdown.droptext = self.menu:draw("Text", {Position = dropdown.button.Position + v2(200, 2), Size = 14, Color = Insight.win.theme.text, Text = "-", Visible = visible}, "text")
    ...
    local function addSlider(self, text, default, min, max, step, suffix, callback, unsafe)
        ...
        slider.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 16), Size = v2(213, 11), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        slider.button = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 3), {Position = slider.buttonoutline.Position + v2(1, 1), Size = v2(211, 9), Color = Insight.win.theme.background, Visible = visible})
        slider.highlight = modifyDrawing(self.menu:gradient({Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.25)}, 3), {Position = slider.button.Position, Size = v2(math.clamp(ratio * 211, 0, 211), 9), Color = Insight.win.theme.accent, Visible = visible})
        slider.text = self.menu:draw("Text", {Position = slider.buttonoutline.Position + v2(2, -15), Size = 14, Color = Insight.win.theme.text, Text = text, Visible = visible}, "text")
        slider.valuetext = self.menu:draw("Text", {Position = slider.button.Position + v2(106, -3), Size = 14, Center = true, Color = Insight.win.theme.text, Text = tostring(default) .. slider.suffix, Visible = visible}, "text")
    ...
    local function addColorToToggle(self, name, default, callback)
        ...
        default = default or Insight.win.theme.accent
        color.name = name or "Color"
        color.callback = callback
        color.toggle = self
        color.value = default
        color.AddColorPicker = addColorToToggle
        color.buttonoutline = self.menu:draw("Square", {Position = self.buttonoutline.Position + v2(187 - self.additions, 1), Size = v2(26, 12), Color = Insight.win.theme.outline, Visible = visible}, "outline")
    ...
    local function addKeybindToToggle(self, default, name)
        if not self.keybind then
            ...
            keybind.buttonoutline = self.menu:draw("Square", {Position = self.buttonoutline.Position + v2(171 - self.additions, 0), Size = v2(42, 14), Color = Insight.win.theme.outline, Visible = visible}, "outline")
            keybind.button = self.menu:draw("Square", {Position = keybind.buttonoutline.Position + v2(1, 1), Size = v2(40, 12), Color = Insight.win.theme.hidden, Visible = visible}, "hidden")
            keybind.text = self.menu:draw("Text", {Position = keybind.button.Position + v2(21, -2), Size = 14, Color = Insight.win.theme.text, Text = default, Center = true, Visible = visible}, "text")
    ...
    local function setToggleValue(self, value)
        self.value = value
        self.button:SetColor(value and {Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.25)} or {Insight.win.theme.lightbackground, Insight.win.theme.background})
    ...
    local function addToggle(self, text, default, callback, unsafe)
        ...
        toggle.buttonoutline = self.menu:draw("Square", {Position = container + v2(0, 3), Size = v2(11, 11), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        --toggle.button = self.menu:draw("Square", {Position = toggle.buttonoutline.Position + v2(1, 1), Size = v2(9, 9), Color = default and Insight.win.theme.accent or Insight.win.theme.background, Visible = visible}, "background")
        toggle.button = modifyDrawing(self.menu:gradient({Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.25)}, 3), {Position = toggle.buttonoutline.Position + v2(1, 1), Size = v2(9, 9), Color = default and Insight.win.theme.accent or Insight.win.theme.background, Visible = visible})
        toggle.text = self.menu:draw("Text", {Position = toggle.buttonoutline.Position + v2(16, -2), Size = 14, Color = Insight.win.theme.text, Text = text, Visible = visible}, "text")
        ...
        toggle.button:SetColor(not default and {Insight.win.theme.lightbackground, Insight.win.theme.background})
        return toggle
    end
    ...
    local function addSection(self, text)
        ...
        section.buttonoutline = self.menu:draw("Square", {Position = lastButton.Position + v2(lastButton.Size.X + 1, 0), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        section.button = self.menu:draw("Square", {Position = section.buttonoutline.Position + v2(0, 0), Color = Insight.win.theme.hidden, Visible = visible}, "hidden")
        section.text = self.menu:draw("Text", {Size = 14, Color = Insight.win.theme.hiddenText, Center = true, Text = text, Visible = visible}, "text")
    ...
    local function createSection(self, text, right, height)
        ...
        section.outline = self.menu:draw("Square", {Size = v2(231, height), Position = self.menu.sectionbg.Position + v2(7 + (right and 235 or 0), 3 + self[side]), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        section.highlightoutline = self.menu:draw("Square", {Size = v2(229, 4), Position = section.outline.Position + v2(1, 1), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        section.highlight = modifyDrawing(self.menu:gradient({Insight.win.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.4)}, 3), {Size = v2(229, 3), Position = section.highlightoutline.Position, Color = Insight.win.theme.accent, Visible = visible})
        section.buttons = self.menu:draw("Square", {Size = v2(229, 20), Position = section.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.hidden, Visible = visible}, "hidden")
        section.buttonoutline = self.menu:draw("Square", {Position = section.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        section.button = self.menu:draw("Square", {Position = section.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.background, Visible = visible}, "background")
        section.buttonbackground = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 8), {Position = section.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.background, Visible = visible})
        section.text = self.menu:draw("Text", {Size = 14, Color = Insight.win.theme.text, Center = true, Text = text, Visible = visible}, "text")
        ...
        section.text.ZIndex = 3
        section.background = self.menu:draw("Square", {Size = v2(229, height - 27), Position = section.outline.Position + v2(1, 26), Color = Insight.win.theme.background, Visible = visible}, "background")
        section.menu = self.menu
        section.tab = self
        section.name = text
        ...
        local function updateListText()
            ...
            for playerIndex = 1, 9 do
                ...
                if player then
                    ...
                    playerdrawings.team.Color = isteamed and player.TeamColor.Color or Insight.win.theme.text
                    playerdrawings.status.Text = islocal and "Local Player" or status[player] or "None"
                    playerdrawings.status.Color = islocal and Color3.new(0.407843, 0, 0.87451) or Insight.win.theme.text
                end
            end
        end
    ...
    local function createPlayerList(self, statuslist, callbacks)
        ...
        playerlist.outline = self.menu:draw("Square", {Size = v2(231 + 235, height), Position = self.menu.sectionbg.Position + v2(7, 3), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.highlightoutline = self.menu:draw("Square", {Size = v2(229 + 235, 4), Position = playerlist.outline.Position + v2(1, 1), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.highlight = modifyDrawing(self.menu:gradient({Insight.win.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.4)}, 3), {Size = v2(229 + 235, 3), Position = playerlist.highlightoutline.Position, Color = Insight.win.theme.accent, Visible = visible})
        playerlist.buttons = self.menu:draw("Square", {Size = v2(229 + 235, 20), Position = playerlist.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.hidden, Visible = visible}, "hidden")
        playerlist.buttonoutline = self.menu:draw("Square", {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.button = self.menu:draw("Square", {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.background, Visible = visible}, "background")
        playerlist.buttonbackground = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 8), {Position = playerlist.highlightoutline.Position + v2(0, 4), Color = Insight.win.theme.background, Visible = visible})
        playerlist.text = self.menu:draw("Text", {Size = 14, Color = Insight.win.theme.text, Center = true, Text = "Player List", Visible = visible}, "text")
        ...
        playerlist.background = self.menu:draw("Square", {Size = v2(229 + 235, height - 27), Position = playerlist.outline.Position + v2(1, 26), Color = Insight.win.theme.background, Visible = visible}, "background")
        playerlist.playerBoxOutline = self.menu:draw("Square", {Size = v2(229 + 235 - 16, 210), Position = playerlist.outline.Position + v2(9, 26 + 18), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.playerBoxBackground = self.menu:draw("Square", {Size = v2(229 + 235 - 16 - 2, 208), Position = playerlist.outline.Position + v2(10, 26 + 19), Color = Insight.win.theme.background, Visible = visible}, "background")
        playerlist.playerPFPOutline = self.menu:draw("Square", {Size = v2(74, 74), Position = playerlist.outline.Position + v2(9, 26 + 18 + 8 + 210), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        ...
        --playerlist.playerPFP = self.menu:draw("Square", {Size = v2(72, 72), Position = playerlist.outline.Position + v2(10, 26 + 18 + 8 + 211), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.statusbuttonoutline = self.menu:draw("Square", {Size = v2(149, 20), Position = playerlist.outline.Position + v2(308, 26 + 18 + 210 + 22), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.statusbutton = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Size = v2(147, 18), Position = playerlist.outline.Position + v2(309, 26 + 18 + 210 + 23), Visible = visible})
        playerlist.votekickbuttonoutline = self.menu:draw("Square", {Size = v2(69, 20), Position = playerlist.outline.Position + v2(308, 26 + 18 + 210 + 53), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.votekickbutton = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Size = v2(67, 18), Position = playerlist.outline.Position + v2(309, 26 + 18 + 210 + 54), Visible = visible})
        playerlist.spectatebuttonoutline = self.menu:draw("Square", {Size = v2(69, 20), Position = playerlist.outline.Position + v2(308 + 80, 26 + 18 + 210 + 53), Color = Insight.win.theme.outline, Visible = visible}, "outline")
        playerlist.spectatebutton = modifyDrawing(self.menu:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Size = v2(67, 18), Position = playerlist.outline.Position + v2(308 + 81, 26 + 18 + 210 + 54), Visible = visible})

        playerlist.nametext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4, -17), Size = 14, Color = Insight.win.theme.text, Text = "Name", Visible = visible}, "text")
        playerlist.teamtext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4 + 148, -17), Size = 14, Color = Insight.win.theme.text, Text = "Team", Visible = visible}, "text")
        playerlist.statuslabeltext = self.menu:draw("Text", {Position = playerlist.playerBoxOutline.Position + v2(4 + 298, -17), Size = 14, Color = Insight.win.theme.text, Text = "Status", Visible = visible}, "text")
        playerlist.playertext = self.menu:draw("Text", {Position = playerlist.playerPFP.Position + v2(78, -2), Size = 14, Color = Insight.win.theme.text, Text = "No Player Selected", Visible = visible}, "text")
        playerlist.playerstatustext = self.menu:draw("Text", {Position = playerlist.statusbuttonoutline.Position + v2(-1, -17), Size = 14, Color = Insight.win.theme.text, Text = "Player Status", Visible = visible}, "text")
        playerlist.statustext = self.menu:draw("Text", {Position = playerlist.playerstatustext.Position + v2(6, 19), Size = 14, Color = Insight.win.theme.text, Text = "None", Visible = visible}, "text")
        playerlist.droptext = self.menu:draw("Text", {Position = playerlist.playerstatustext.Position + v2(137, 20), Size = 14, Color = Insight.win.theme.text, Text = "-", Visible = visible}, "text")
        playerlist.votekicktext = self.menu:draw("Text", {Position = playerlist.votekickbutton.Position + v2(33, 1), Size = 14, Center = true, Color = Insight.win.theme.text, Text = "Votekick", Visible = visible}, "text")
        playerlist.spectatetext = self.menu:draw("Text", {Position = playerlist.spectatebutton.Position + v2(33, 1), Size = 14, Center = true, Color = Insight.win.theme.text, Text = "Spectate", Visible = visible}, "text")

        playerlist.carrot = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(437, -1), Size = 14, Outline = false, Color = Insight.win.theme.accent, Text = "^", Visible = visible}, "accent")
        playerlist.tinyv = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(437, 195), Size = 11, Outline = false, Color = Insight.win.theme.accent, Text = "v", Visible = visible}, "accent")
        ...
        for playerIndex = 1, 9 do
            ...
            if playerIndex ~= 9 then
                drawinglist.sectionline = self.menu:draw("Square", {Size = v2(438, 1), Position = playerlist.playerBoxBackground.Position + v2(4, 23 * playerIndex), Color = Insight.win.theme.outline, Visible = visible}, "outline")
            end

            drawinglist.teamline = self.menu:draw("Square", {Size = v2(1, playerIndex ~= 9 and 16 or 17), Position = playerlist.playerBoxBackground.Position + v2(148, 23 * (playerIndex - 1) + 4), Color = Insight.win.theme.outline, Visible = visible}, "outline")
            drawinglist.statusline = self.menu:draw("Square", {Size = v2(1, playerIndex ~= 9 and 16 or 17), Position = playerlist.playerBoxBackground.Position + v2(298, 23 * (playerIndex - 1) + 4), Color = Insight.win.theme.outline, Visible = visible}, "outline")
            drawinglist.name = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(4, 23 * (playerIndex - 1) + 5), Size = 14, Color = Insight.win.theme.text, Text = "", Visible = visible}, "text")
            drawinglist.team = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(152, 23 * (playerIndex - 1) + 5), Size = 14, Color = Insight.win.theme.text, Text = "", Visible = visible}, "text")
            drawinglist.status = self.menu:draw("Text", {Position = playerlist.playerBoxBackground.Position + v2(302, 23 * (playerIndex - 1) + 5), Size = 14, Color = Insight.win.theme.text, Text = "", Visible = visible}, "text")
    ...
    local function createTab(self, text)
        ...
        tab.title = self:draw("Text", {Size = 15, Position = tab.button.Position + v2(48, 11), Color = Insight.win.theme[tab.tabIndex == self.tabIndex and "text" or "hiddenText"], Text = text, Center = true, Visible = self.open}, "text")
    ...
    local function createKeyList(self, includeKeyName)
        ...
        keys.outline = keys:draw("Square", {Color = Insight.win.theme.outline, Visible = true}, "outline")
        keys.background = keys:draw("Square", {Color = Insight.win.theme.background, Visible = true}, "background")
        keys.titlebackground = modifyDrawing(keys:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 7), {Color = Insight.win.theme.accent, Visible = true})
        keys.highlightoutline = keys:draw("Square", {Color = Insight.win.theme.outline, Visible = true}, "outline")
        keys.highlight = modifyDrawing(keys:gradient({Insight.win.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.4)}, 3), {Color = Insight.win.theme.accent, Visible = true})
        keys.title = keys:draw("Text", {Size = 16, Color = Insight.win.theme.text, Text = "Keybinds", Visible = true}, "text")
        ...
        local function updateKeybinds()
            ...
            for _, keyData in self.keybinds do
                ...
                insert(newkeybinds, {keys:draw("Text", {Size = 16, Color = Insight.win.theme.text, Text = text, Visible = true}, "text"), keybind})
            end
    ...
    function Insight.win:CreateMenu(title, visible, index)
        if visible == nil then
            visible = true
        end
    ...
    table.insert(connectionList, userInputService.InputBegan:Connect(function(input)
        if input.KeyCode ~= Enum.KeyCode.Unknown then
            ...
            for _, menuData in Insight.win.menus do
            ...
            if input.KeyCode == Enum.KeyCode[Insight.win.toggleKeybind] and clockTime - lastToggle > fadeDuration * 2 and not dragging and not sliding and not dropping and not picking then
                Insight.win.open = not Insight.win.open
                lastToggle = clockTime

                for _, menu in Insight.win.menus do
                    local trans = (Insight.win.open and 0 or 1) --menu.background.Transparency
                    local stepFactor = 1 / fadeSteps
                    local step = stepFactor * (Insight.win.open and 1 or -1)
                    ...
                    if onInside then
                        ...
                        if mouse.Y < sectionbg.Y then
                            if clicked then
                                ...
                                oldTab.title.Color = Insight.win.theme.hiddenText
                                newTab.title.Color = Insight.win.theme.text
                                ...
                                oldButton.Color = Insight.win.theme.hidden
                                newButton.Color = Insight.win.theme.background
                                        ...
                                        if sectionData.selected then
                                            ...
                                            if checkDrawing(mouse, statusButton) then
                                                ...
                                                for statusIndex = 1, #sectionData.statuslist + 1 do
                                                    ...
                                                    buttonData.outline = statusdropping:draw("Square", {Size = v2(149, 20), Position = statusButton.Position + v2(0, 19 * statusIndex), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4}, "outline")
                                                    buttonData.button = statusdropping:draw("Square", {Size = v2(147, 18), Position = buttonData.outline.Position + v2(1, 1), Color = Insight.win.theme.background, Visible = true, ZIndex = 4}, "outline")
                                                    buttonData.text = statusdropping:draw("Text", {Position = buttonData.button.Position + v2(4, 1), Size = 14, Color = Insight.win.theme.text, Text = statusName, Visible = true, ZIndex = 4}, "text")
                                        ...
                                        if clicked then
                                            for sectionIndex, section in sectionData.sections do
                                                if checkDrawing(mouse, section.button) then
                                                    ...
                                                    oldSec.text.Color = Insight.win.theme.hiddenText
                                                    section.text.Color = Insight.win.theme.text
                                                    oldSec.button.Size = oldSec.button.Size - v2(0, 1)
                                                    section.button.Size = section.button.Size + v2(0, 1)
                                                    oldSec.button.Color = Insight.win.theme.hidden
                                                    section.button.Color = Insight.win.theme.background
                                                ...
                                                if checkBounds(relPos - v2(0, height), v2(230, element.height)) then
                                                    if element.type == "toggle" then
                                                        ...
                                                        for _, color in element.colors do
                                                            if checkDrawing(mouse, color.buttonoutline) then
                                                                ...
                                                                picker.outline = picker:draw("Square", {Position = color.toggle.buttonoutline.Position + v2(-57, -8), Size = v2(275, 217), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.background = picker:draw("Square", {Position = picker.outline.Position + v2(1, 1), Size = v2(273, 215), Color = Insight.win.theme.background, Visible = true, ZIndex = 4})
                                                                picker.highlightbackground = picker:draw("Square", {Position = picker.outline.Position + v2(1, 1), Size = v2(273, 4), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.highlight = modifyDrawing(picker:gradient({Insight.win.theme.accent:Lerp(Color3.new(1, 1, 1), 0.1), Insight.win.theme.accent, darken(Insight.win.theme.accent, 0.4)}, 3), {Position = picker.highlightbackground.Position, Size = v2(273, 3), Visible = true, ZIndex = 4})
                                                                picker.titlebackground = modifyDrawing(picker:gradient({Insight.win.theme.lightbackground, Insight.win.theme.background}, 6), {Size = v2(273, 17), Position = picker.background.Position + v2(0, 4), Visible = true, ZIndex = 4})
                                                                picker.title = picker:draw("Text", {Position = picker.background.Position + v2(3, 3), Size = 14, Color = Insight.win.theme.text, Text = color.name, Visible = true, ZIndex = 4})
                                                                picker.hsvOutline = picker:draw("Square", {Position = picker.background.Position + v2(7, 19), Size = v2(202 - 18 - 16, 168), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                picker.hueOutline = picker:draw("Square", {Position = picker.hsvOutline.Position + v2(7 + picker.hsvOutline.Size.X, 0), Size = v2(12, 168), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.valueOutline = picker:draw("Square", {Position = picker.background.Position + v2(7, 195), Size = v2(202 - 18 - 16, 12), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.newtext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(19, -2), Size = 14, Color = Insight.win.theme.text, Text = "New Color", Visible = true, ZIndex = 4})
                                                                picker.newOutline = picker:draw("Square", {Position = picker.newtext.Position + v2(0, 17), Size = v2(65, 35), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.oldtext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(19, 52), Size = 14, Color = Insight.win.theme.text, Text = "Old Color", Visible = true, ZIndex = 4})
                                                                picker.oldOutline = picker:draw("Square", {Position = picker.oldtext.Position + v2(0, 17), Size = v2(65, 35), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.applytext = picker:draw("Text", {Position = picker.hueOutline.Position + v2(27, 175), Size = 14, Color = Insight.win.theme.text, Text = "[  Apply  ]", Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.hsvButtonOutline = picker:draw("Square", {Position = startPos + v2(s * 166 - 2, (1 - v) * 166 - 2), Size = v2(5, 5), Filled = false, Thickness = 1, Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.hueButtonOutline = picker:draw("Square", {Position = picker.hue.Position + v2(-3, (1 - h) * 166 - 3), Size = v2(16, 5), Filled = false, Thickness = 1, Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                                ...
                                                                picker.valueButtonOutline = picker:draw("Square", {Position = picker.valuebar.Position + v2(v * 166 - 3, -3), Size = v2(5, 16), Filled = false, Thickness = 1, Color = Insight.win.theme.outline, Visible = true, ZIndex = 4})
                                                    ...
                                                    elseif element.type == "dropdown" then
                                                        ...
                                                        for optionIndex = 1, #element.options do
                                                            local newDrawings = {}
                                                            newDrawings.outline = menuData:draw("Square", {Position = element.buttonoutline.Position + v2(0, optionIndex * 17), Size = v2(213, 18), Color = Insight.win.theme.outline, Visible = true, ZIndex = 4}, "outline")
                                                            newDrawings.button = menuData:draw("Square", {Position = newDrawings.outline.Position + v2(1, 1), Size = v2(211, 16), Color = Insight.win.theme.background, Visible = true, ZIndex = 4}, "background")
                                                            newDrawings.valuetext = menuData:draw("Text", {Position = newDrawings.button.Position + v2(6, 0), Size = 14, Color = Insight.win.theme.text, Text = element.options[optionIndex], Visible = true, ZIndex = 4}, "text")
...
LPH_JIT_MAX(function() -- Main Cheat
    ...
    local pathfinding = loadstring(game:HttpGet("https://raw.githubusercontent.com/ikjase14/Insight.win/refs/heads/main/pathfinding.lua"))() -- i didnt make this, i did fix it tho cuz pro
    ...
    local function scanPositions(origin, target, accel, speed, penetration)
        local origins = getPositionOffsets(origin, target, Insight.win:GetValue("Rage Bot", "Fire Position Scanning") and Insight.win:GetValue("Rage Bot", "Fire Position Offset"))
        local targets = getPositionOffsets(target, origin, Insight.win:GetValue("Rage Bot", "Hit Position Scanning") and Insight.win:GetValue("Rage Bot", "Hit Position Offset"))
    ...
    local function applyAAAngles(angles)
        ...
        if Insight.win:GetValue("Anti Aim", "Pitch") then
            local addition = rad(Insight.win:GetValue("Anti Aim", "Pitch Amount")) - quarter

            if string.find(string.lower(Insight.win:GetValue("Anti Aim", "Pitch Mode")), "abs") then
                x = addition
            else
                x += addition
            end
        ...
        if Insight.win:GetValue("Anti Aim", "Yaw") then
            local addition = rad(Insight.win:GetValue("Anti Aim", "Yaw Amount"))

            if string.find(string.lower(Insight.win:GetValue("Anti Aim", "Yaw Mode")), "rel") then
                y += addition
            else
                y = addition
            end
        ...
        if Insight.win:GetValue("Anti Aim", "Spin Bot") then
            y += (os.clock() - startTime) * math.rad(Insight.win:GetValue("Anti Aim", "Spin Speed")) * ((Insight.win:GetValue("Anti Aim", "Spin Direction") == "Left" and 1) or -1)
        end
    ...
    function network:send(name, ...)
        if Insight.win:GetValue("Third Person", "Enabled") and Insight.win:GetValue("Third Person", "Show Character") then
            if name == "spawn" then
                if not started then
                    started = true
                end
            ...
            if currentObj then
                ...
                elseif name == "stance" then
                    ...
                    if (not Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") or not Insight.win:GetValue("Anti Aim", "Force Stance") or not Insight.win:GetValue("Third Person", "Apply Anti Aim To Character")) and currentObj then
        ...
        elseif name == "repupdate" then
            ...
            if newSpawnCache.noclipping then -- this is fried and i broke it somehow
                ...
                return
            elseif Insight.win:GetValue("Movement", "Noclip") and newSpawnCache.lastUpdate then
            ...
            if Insight.win:GetValue('Anti Aim', 'Fake Lag') then
                ...
                if ((position - fakelag.lastRefreshPosition).Magnitude > Insight.win:GetValue('Anti Aim', 'Refresh Distance')) or tick() - fakelag.lastRefreshTime > Insight.win:GetValue('Anti Aim', 'Refresh Rate') then
                    fakelag.lastRefreshPosition = position;
                    fakelag.lastRefreshTime = tick();

                    if Insight.win:GetValue('Anti Aim', 'Randomize Position') then
                        local xaxis, yaxis, zaxis = Insight.win:GetValue('Anti Aim', 'X-Axis Factor'), 0, Insight.win:GetValue('Anti Aim', 'Z-Axis Factor');
            ...
            if Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") then
                angles = applyAAAngles(angles)
                angles2 = angles * 0.99
            end

            --if Insight.win:GetValue("Rage Bot", "Enabled") and Insight.win:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then
            ...
            --local fly = false --Insight.win:GetValue("Movement", "Fly") or (Insight.win:GetValue("Rage Bot", "Enabled") and Insight.win:GetValue("Rage Bot", "Firerate (May Cause Kicking)"))
            ...
            if Insight.win:GetValue("Movement", "Walk Speed") and newSpawnCache.lastUpdate then -- no patch pls :(
                send(self, name, newSpawnCache.lastUpdate, angles, angles2, time + newSpawnCache.latency + newSpawnCache.currentAddition)
                newSpawnCache.updateDebt += 1
            end;
        ...
        elseif name == "newbullets" then
            ...
            if Insight.win:GetValue("Rage Bot", "Enabled") then
                return
            end

            if Insight.win:GetValue("Silent Aim", "Enabled") and (Insight.win:GetValue("Silent Aim", "Hit Chance") >= chanceOne) then
                local target, entry, part = getClosest(silentaimfov.Position, Insight.win:GetValue("Silent Aim", "Use FOV") and silentaimfov.Radius, Insight.win:GetValue("Silent Aim", "Use Dead FOV") and silentaimdeadfov.Radius, Insight.win:GetValue("Silent Aim", "Visible Check"), (Insight.win:GetValue("Silent Aim", "Head Shot Chance") >= chanceTwo) and "Head" or "Torso")
        ...
        elseif name == "falldamage" and Insight.win:GetValue("Movement", "No Fall Damage") then
            return
        elseif name == "stance" then
        ...
        elseif timeUpdates[name] then
            ...
            if name == "equip" then
                ...
                if Insight.win:GetValue("Knife Bot", "Kill All (May Despawn)") and not Insight.win:GetValue("Knife Bot", "Only When Holding Knife") then
                    args[1] = 3
                end
            end
        ...
        elseif name == "ping" then
            ...
            --if Insight.win:GetValue("Rage Bot", "Enabled") and Insight.win:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then -- idk if this needs to be here i think it helps a little
        ...
        if Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") then
            if name == "stance" and Insight.win:GetValue("Anti Aim", "Force Stance") then
                local stance = ...
                stance = string.lower(Insight.win:GetValue("Anti Aim", "Set Stance"))

                if Insight.win:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                    currentObj:setStance(stance)
                end
    ...
    screenCull.step = LPH_NO_VIRTUALIZE(function(...)
        ...
        if Insight.win:GetValue("Third Person", "Enabled") then
            local controller = weaponInterface.getActiveWeaponController()

            if controller and (Insight.win:GetValue("Third Person", "Show Character While Aiming") or not controller:getActiveWeapon()._aiming) then
                local cameraOffset = Vector3.new(Insight.win:GetValue("Third Person", "Camera Offset X"), Insight.win:GetValue("Third Person", "Camera Offset Y"), Insight.win:GetValue("Third Person", "Camera Offset Z"))
                local didHit = false

                if Insight.win:GetValue("Third Person", "Camera Offset Always Visible") then
    ...
    function bulletObject.new(bulletData)
        if bulletData.onplayerhit then
            ...
            if Insight.win:GetValue("World Visuals", "Bullet Tracers") or Insight.win:GetValue("World Visuals", "Impact Points") then
                local frames, hits = simulateBullet(bulletData.position, bulletData.velocity, bulletData.penetrationdepth)

                if Insight.win:GetValue("World Visuals", "Bullet Tracers") then
                    local endColor = Insight.win:GetValue("World Visuals", "Color One")
                    local startColor = Insight.win:GetValue("World Visuals", "Color Two")
                    local diameter = Insight.win:GetValue("World Visuals", "Tracers Size")
                    ...
                    for frame = 1, frameCount do -- god damn perfect bullet tracers
                        ...
                        tracer.Material = Enum.Material[Insight.win:GetValue("World Visuals", "Tracers Material")]
                        tracer.Transparency = Insight.win:GetValue("World Visuals", "Tracers Transparency") * 0.01
                        ...
                        task.delay(Insight.win:GetValue("World Visuals", "Duration"), function()
                ...
                if Insight.win:GetValue("World Visuals", "Impact Points") then
                    for wall = 1, #hits do
                        local point = Instance.new("Part")
                        point.Material = Enum.Material[Insight.win:GetValue("World Visuals", "Points Material")]
                        point.Transparency = Insight.win:GetValue("World Visuals", "Points Transparency") * 0.01
                        point.Anchored = true
                        point.CanCollide = false
                        point.Color = Insight.win:GetValue("World Visuals", "Points Color")
            ...
            if Insight.win:GetValue("Backtracking", "Enabled") or Insight.win:GetValue("Hit Boxes", "Enabled") then
                ...
                bulletData.ontouch = function(self, part, position, normal, exit, exitnorm) -- goated hitbox method
                    if not ticketCache[extra.bulletTicket] then
                        if Insight.win:GetValue("Hit Boxes", "Enabled") and part:IsDescendantOf(hitboxObjects) then
                            ticketCache[extra.bulletTicket] = true
                            send(network, "bullethit", extra.uniqueId, players[part.Name], position, Insight.win:GetValue("Hit Boxes", "Hit Part"), extra.bulletTicket + ticketAddition, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
                        elseif Insight.win:GetValue("Backtracking", "Enabled") and part:IsDescendantOf(backtrackObjects) then
                            local model = part
    ...
    function hudScopeInterface.updateScope(...)
        if Insight.win:GetValue("Gun Mods", "No Sniper Scope") then -- more scripts need this
    ...
    function recoil.applyImpulse(...)
        if aimbotting or Insight.win:GetValue("Gun Mods", "No Recoil") then
            return
        end
    ...
    function firearmObject:reload()
        if Insight.win:GetValue("Gun Mods", "Instant Reload") and self._spareCount > 0 then
    ...
    function firearmObject:computeWalkSway(dy, dx)
        if Insight.win:GetValue("Gun Mods", "No Walk Sway") or aimbotting then
            dy = 0
            dx = 0
        end
    ...
    function firearmObject.computeGunSway(...)
        if Insight.win:GetValue("Gun Mods", "No Gun Sway") or aimbotting then
    ...
    function cframeLib.fromAxisAngle(x, y, z) -- luh freak
        if aimbotting then -- or Insight.win:GetValue("Gun Mods", "No Camera Sway") then
            local controller = weaponInterface.getActiveWeaponController()
            local weapon = controller and controller:getActiveWeapon()
    ...
    function modifyData.getModifiedData(data, ...)
        ...
        if Insight.win:GetValue("Gun Mods", "No Spread") then
            data.hipfirespread = 0
            data.hipfirestability = 99999
            data.hipfirespreadrecover = 99999
        end

        if Insight.win:GetValue("Gun Mods", "Small Crosshair") then
            data.crosssize = 10
        ...
        if Insight.win:GetValue("Gun Mods", "No Crosshair") then
    ...
    cameraObject.step = LPH_NO_VIRTUALIZE(function(self, dt)
        if aimbotting or Insight.win:GetValue("Gun Mods", "No Camera Sway") then
            mainStep(self, 0)
            self._lookDt = dt
        end

        if Insight.win:GetValue('Gun Mods', 'No Camera Bob') then
        ...
        if aimbotting or Insight.win:GetValue("Gun Mods", "No Camera Sway") or Insight.win:GetValue('Gun Mods', 'No Camera Bob') then
            return;
        end;
...
--[[ synz has upval instability
    ...
    debug.setupvalue(cameraObject.step, 2, {fromAxisAngle = function(...)
        return (aimbotting or Insight.win:GetValue("Gun Mods", "No Camera Sway")) and CFrame.identity or cframeLib.fromAxisAngle(...)
    ...
    function audioSystem.playSoundId(assetId, priority, volume, pitch, part, maxPartDist, pitchRange, randomPitch, emitterSize, rollOffMode, playOnRemove, looped)
        if Insight.win:GetValue("Sounds", "Shoot Sound") ~= "None" then
            local controller = weaponInterface.getActiveWeaponController()
            local weapon = controller and controller:getActiveWeapon()

            if weapon and assetId == weapon:getWeaponStat("firesoundid") then
                return playSoundId(customAudios[Insight.win:GetValue("Sounds", "Shoot Sound")], priority, volume)
            end
        end
    ...
    function audioSystem.playSound(soundName, ...)
        ...
        if Insight.win:GetValue("Sounds", "Hit Sound") ~= "None" and soundName == "hitmarker" then
            return playSoundId(customAudios[Insight.win:GetValue("Sounds", "Hit Sound")], 1, args[3])
        elseif Insight.win:GetValue("Sounds", "Footstep Sound") ~= "None" and (args[1] == "SelfFoley") then
            return playSoundId(customAudios[Insight.win:GetValue("Sounds", "Footstep Sound")], args[2], args[3])
        elseif Insight.win:GetValue("Sounds", "Kill Sound") ~= "None" and (soundName == "killshot" or soundName == "headshotkill") then
            return playSoundId(customAudios[Insight.win:GetValue("Sounds", "Kill Sound")], 1, args[3])
        elseif Insight.win:GetValue("Sounds", "Got Hit Sound") ~= "None" and (soundName == "crackSmall" or soundName == "crackBig") then
            return playSoundId(customAudios[Insight.win:GetValue("Sounds", "Got Hit Sound")], 1, args[3])
        end
    ...
    function effects.breakwindow(part, receiveWindow, netTime)
        if part.Name ~= "Window" then
            return
        elseif Insight.win:GetValue("Sounds", "Glass Breaking Sound") ~= "None" then
                ...
                if child.ClassName == "Part" and child.CFrame == part.CFrame then
                    child.ChildAdded:Connect(function(sound)
                        if sound.ClassName == "Sound" then
                            sound.SoundId = customAudios[Insight.win:GetValue("Sounds", "Glass Breaking Sound")] or ""
                        end
                    end)
                end
            end)
    ...
    function charObject:setBaseWalkSpeed(speed)
        ...
        return setBaseWalkSpeed(self, Insight.win:GetValue("Movement", "Walk Speed") and Insight.win:GetValue("Movement", "Set Speed") or speed)
    end

    local jump = charObject.jump
    function charObject:jump(height, vaulting)
        return jump(self, 4 + (Insight.win:GetValue("Movement", "Jump Power") and Insight.win:GetValue("Movement", "Height Addition") or 0), vaulting)
    end
    ...
    callbackList["Movement%%Walk Speed"] = function(state)
        if charInterface.isAlive() then
            ...
            if state then
                setBaseWalkSpeed(object, Insight.win:GetValue("Movement", "Set Speed"))
            else
    ...
    callbackList["Tweaks%%Custom Kill Notification"] = function(state)
        hudnotify.typeList.kill[1] = state and Insight.win:GetValue("Tweaks", "Notification Text") or "Enemy Killed!"
    end

    callbackList["Tweaks%%Notification Text"] = function(state)
        if Insight.win:GetValue("Tweaks", "Custom Kill Notification") then
    ...
    callbackList["Anti Aim%%Enabled (May Cause Despawning)"] = function(state)
        ...
        if charInterface.isAlive() then
            if Insight.win:GetValue("Third Person", "Show Character") and Insight.win:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                if Insight.win:GetValue("Anti Aim", "Force Stance") then
                    local stance = state and Insight.win:GetValue("Anti Aim", "Set Stance") or newSpawnCache.stance or "stand"
                    currentObj:setStance(stance)
                end

                if Insight.win:GetValue("Anti Aim", "Jitter") then
            ...
            if Insight.win:GetValue("Anti Aim", "Jitter") and not state then
    ...
    callbackList["Third Person%%Enabled"] = function(state)
        if charInterface.isAlive() and Insight.win:GetValue("Third Person", "Show Character") then
            if state then
                started = true
            else
    ...
    --    if Insight.win:GetValue("Movement", "Noclip") and ref.ClassName == "Model" then
    ...
    local function updateCrosshair()
        local enabled = Insight.win:GetValue("Crosshair", "Enabled")
        crossdot.Visible = enabled and Insight.win:GetValue("Crosshair", "Show Dot")
        ...
        if not Insight.win:GetValue("Crosshair", "Rainbow Crosshair") then
            local color = Insight.win:GetValue("Crosshair", "Crosshair Color")
    ...
    local function updateCrosshairPos(force) -- i didnt want to make this
        local barrel = Insight.win:GetValue("Crosshair", "Follow Recoil") and getBarrelLocation()
        ...
        local sx = Insight.win:GetValue("Crosshair", "X Space") * 0.5
        local sy = Insight.win:GetValue("Crosshair", "Y Space") * 0.5
        local w = Insight.win:GetValue("Crosshair", "X Size")
        local h = Insight.win:GetValue("Crosshair", "Y Size")
        local speed = Insight.win:GetValue("Crosshair", "Spin Speed")
    ...
    table.insert(connectionList, camera.ChildAdded:Connect(function(model)
        if model.ClassName == "Model" then
            ...
            if Insight.win:GetValue("Chams", prefix .. "Chams") then
                local properties, uncache = cham.new(model, {
                    Material = Enum.Material[Insight.win:GetValue("Chams", prefix .. "Material")],
                    Transparency = Insight.win:GetValue("Chams", prefix .. "Transparency") * 0.01,
                    Color = Insight.win:GetValue("Chams", prefix .. "Color")
                }, false, true, false)
    ...
    function networkConnections.startvotekick(username, delay, votes)
        if Insight.win:GetValue("Server Hopper", "Server Hop On Votekick") and username == localPlayer.Name then -- this should work mf
            hopServers()
        end
    ...
    local function chatSpam() -- idk why this doesnt work on some exploits
        ...
        if Insight.win:GetValue("Chat Spam", "Enabled") then
            local list = chatSpamLists[Insight.win:GetValue("Chat Spam", "Spam List")]
            ...
            --network:send("sendChatMessage", list[newSpamIndex], Insight.win:GetValue("Chat Spam", "Team Chat"))
            globalChannel:SendAsync(list[newSpamIndex]);
            lastSpamIndex = newSpamIndex
        end

        task.delay(Insight.win:GetValue("Chat Spam", "Spam Delay"), chatSpam)
    end
    ...
    local function initKnifeBot()
        ...
        while raging do -- i ran out of amphetamines
            ...
            if root then
                ...
                if newSpawnCache.spawned and newSpawnCache.lastUpdate and (clock - newSpawnCache.spawnTime) > 1 and (nextScan - clock) <= 0 and not roundSystem.roundLock and ((not Insight.win:GetValue("Knife Bot", "Only When Holding Knife")) or (newSpawnCache.slot == 3)) then
                    local closestCharacters = getClosestPlayers(newSpawnCache.lastUpdate, true, Insight.win:GetValue("Knife Bot", "Only Kill Target Status"), Insight.win:GetValue("Knife Bot", "Whitelist Friendly Status"))
    ...
    callbackList["Knife Bot%%Kill All (May Despawn)"] = function(state)
        ...
        if charInterface.isAlive() then
            if not Insight.win:GetValue("Knife Bot", "Only When Holding Knife") and newSpawnCache.slot ~= 3 then
                if state then
    ...
    callbackList["Knife Bot%%Only When Holding Knife"] = function(state)
        if Insight.win:GetValue("Knife Bot", "Kill All (May Despawn)") and charInterface.isAlive() and newSpawnCache.slot ~= 3 then
            if state then
                send(network, "equip", newSpawnCache.slot, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
            else
                send(network, "equip", 3, network.getTime() + newSpawnCache.latency + newSpawnCache.currentAddition)
    ...
    callbackList["Custom Model%%Asset ID"] = function(state)
        if Insight.win:GetValue("Custom Model", "Custom Character Model") then
            if customModel then
    ...
    callbackList["Custom Model%%Asset ID"](Insight.win:GetValue("Custom Model", "Asset ID"))
    ...
    table.insert(connectionList, runService.Heartbeat:Connect(LPH_NO_VIRTUALIZE(function(ndt)
        ...
        if controller and weapon then
            local isHidden = (hidden or weapon._blackScoped or ((Insight.win:GetValue("Third Person", "Enabled") and Insight.win:GetValue("Third Person", "Show Character")) and (Insight.win:GetValue("Third Person", "Show Character While Aiming") or not aiming)))
            if isHidden then
        ...
        if customModel and rootPart then
            local part = customModel.ClassName == "Model" and customModel.PrimaryPart or customModel
            part.CFrame = rootPart.CFrame * CFrame.new(Insight.win:GetValue("Custom Model", "Asset Offset X"), Insight.win:GetValue("Custom Model", "Asset Offset Y"), Insight.win:GetValue("Custom Model", "Asset Offset Z"))
        end
            ...
            if rootPart then
                ...
                if currentObj or started then
                    if started then
                        ...
                        if Insight.win:GetValue("More Chams", "Third Person Character Chams") then
                            local _, uncache = cham.new(currentObj._character, {
                                Transparency = Insight.win:GetValue("More Chams", "Character Transparency") * 0.01,
                                Material = Enum.Material[Insight.win:GetValue("More Chams", "Character Material")],
                                Color = Insight.win:GetValue("More Chams", "Character Color")
                            }, false, true, false)
                            objectChamUncache = uncache;
                        end

                        if Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and Insight.win:GetValue("Anti Aim", "Force Stance") and Insight.win:GetValue("Third Person", "Apply Anti Aim To Character") and currentObj then
                            currentObj:setStance(string.lower(Insight.win:GetValue("Anti Aim", "Set Stance")))
                        end
                    end

                    local angles = cameraInterface:getActiveCamera():getAngles()
                    if Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and Insight.win:GetValue("Third Person", "Apply Anti Aim To Character") then
                        angles = applyAAAngles(angles)
                    end
                    ...
                    if not Insight.win:GetValue("Third Person", "Show Character While Aiming") and controller and aiming then
        ...
        if Insight.win:GetValue("Rage Bot", "Enabled") and clockTime > nextShot and not roundSystem.roundLock and not Insight.win:GetValue("Knife Bot", "Kill All (May Despawn)") then --  and newSpawnCache.hasPinged
            ...
            if weapon and weapon._weaponData and newSpawnCache.lastUpdate and not teleporting then
                local origin = newSpawnCache.lastUpdate
                local closestPlayers = getClosestPlayers(origin, false, Insight.win:GetValue("Rage Bot", "Only Shoot Target Status"), Insight.win:GetValue("Rage Bot", "Whitelist Friendly Status"))
                ...
                if closestPlayers and penetration and speed and (weapon._magCount > 0 or weapon._spareCount > 0) then
                    for playerIndex = 1, #closestPlayers do
                        ...
                        if newOrigin then
                            ...
                            if Insight.win:GetValue("Rage Bot", "Shoot Effects") and weapon._barrelPart then
                            ...
                            --if Insight.win:GetValue("Rage Bot", "Firerate (May Cause Kicking)") then
    ...
    table.insert(connectionList, runService.Stepped:Connect(function(time, ndt)
        ...
        if customModel and rootPart then
            local part = customModel.ClassName == "Model" and customModel.PrimaryPart or customModel
            customModel.CFrame = rootPart.CFrame * CFrame.new(Insight.win:GetValue("Custom Model", "Asset Offset X"), Insight.win:GetValue("Custom Model", "Asset Offset Y"), Insight.win:GetValue("Custom Model", "Asset Offset Z"))
        end
        ...
        if Insight.win:GetValue("Anti Aim", "Enabled (May Cause Despawning)") and Insight.win:GetValue("Anti Aim", "Jitter") and rootPart and (clockTime - lastJitter) > (1 / Insight.win:GetValue("Anti Aim", "Jitter Speed") / 2) then
        ...
        if Insight.win:GetValue("Movement", "Bunny Hop") and rootPart and (not Insight.win:GetValue("Movement", "Only While Jumping") or userInputService:IsKeyDown(Enum.KeyCode.Space)) then
            currentCharObject._lastJumpTime = 0
            currentCharObject:jump(4 + (Insight.win:GetValue("Movement", "Jump Power") and Insight.win:GetValue("Movement", "Height Addition") or 0))
        end

        if Insight.win:GetValue("Movement", "Noclip") and rootPart then
        ...
        --[[
        if false then --Insight.win:GetValue("Movement", "Fly") and rootPart then
            ...
            if direction == Vector3.zero then
                ...
                rootPart.Anchored = false
                rootPart.Velocity = direction.Unit * Insight.win:GetValue("Movement", "Fly Speed")
            end
        end
        ]]

        if Insight.win:GetValue("Hit Boxes", "Enabled") then
            replicationInterface.operateOnAllEntries(function(player, entry)
                if player.Team ~= localplayer.Team then
                    ...
                    if entry._receivedPosition then
                        if not sphere then
                            local size = Insight.win:GetValue("Hit Boxes", "Size")
                            sphere = Instance.new("Part")
                            sphere.Name = player.Name
                            sphere.CanCollide = true
                            sphere.Shape = Enum.PartType.Ball
                            sphere.Size = Vector3.new(size, size, size)
                            sphere.Material = Enum.Material[Insight.win:GetValue("Hit Boxes", "Material")]
                            sphere.Transparency = Insight.win:GetValue("Hit Boxes", "Transparency") * 0.01
                            sphere.Color = Insight.win:GetValue("Hit Boxes", "Color")
        ...
        if Insight.win:GetValue("Backtracking", "Enabled") then
            local delay = 1 / Insight.win:GetValue("Backtracking", "Refresh Rate")
            ...
            if clockTime > backtrackTime + delay then
                replicationInterface.operateOnAllEntries(function(player, entry)
                    ...
                    if player.Team ~= localplayer.Team and character then
                        ...
                        if Insight.win:GetValue("Backtracking", "Clone Character") then
                        ...
                        local properties = {
                            Material = Enum.Material[Insight.win:GetValue("Backtracking", "Character Material")],
                            Transparency = Insight.win:GetValue("Backtracking", "Character Transparency") * 0.01,
                            Color = Insight.win:GetValue("Backtracking", "Character Color"),
                            CanCollide = true
                        }
                        ...
                        task.delay(Insight.win:GetValue("Backtracking", "Character Duration"), function()
    ...
    table.insert(connectionList, runService.RenderStepped:Connect(LPH_NO_VIRTUALIZE(function(deltaTime)
        ...
        aimbotting = false
        if Insight.win:GetValue("Aim Bot", "Enabled") and aiming then
            local target, entry, part = getClosest(aimbotfov.Position, Insight.win:GetValue("Aim Bot", "Use FOV") and aimbotfov.Radius, Insight.win:GetValue("Aim Bot", "Use Dead FOV") and aimbotdeadfov.Radius, Insight.win:GetValue("Aim Bot", "Visible Check"), Insight.win:GetValue("Aim Bot", "Target Part"))
            ...
            if target and movementCache.position[entry._player][15] then
                ...
                local smoothing = Insight.win:GetValue("Aim Bot", "Smoothness")
        ...
        local circlePos
        if Insight.win:GetValue("FOV Settings", "FOV Follows Recoil") then
        ...
        if Insight.win:GetValue("FOV Settings", "Dynamic FOV") then
            local factor = not charInterface.isAlive() and 1 or (cameraInterface.getActiveCamera():getBaseFov() / camera.FieldOfView)
            aimbotfov.Radius = Insight.win:GetValue("Aim Bot", "FOV Radius") * factor
            aimbotdeadfov.Radius = Insight.win:GetValue("Aim Bot", "Dead FOV Radius") * factor
            silentaimfov.Radius = Insight.win:GetValue("Silent Aim", "FOV Radius") * factor
            silentaimdeadfov.Radius = Insight.win:GetValue("Silent Aim", "Dead FOV Radius") * factor
        end

        if Insight.win:GetValue("World Visuals", "Ambient") then
            local color = Insight.win:GetValue("World Visuals", "Ambient Color")
            lighting.Ambient = color
            lighting.OutdoorAmbient = color
        end

        if Insight.win:GetValue("Crosshair", "Enabled") then
            if (Insight.win:GetValue("Crosshair", "Spin Speed") > 0) or Insight.win:GetValue("Crosshair", "Follow Recoil") then
                updateCrosshairPos()
            end

            if Insight.win:GetValue("Crosshair", "Rainbow Crosshair") then
                local rainbow = Color3.fromHSV((clockTime * Insight.win:GetValue("Crosshair", "Rainbow Speed")) % 1, 1, 1)
...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    if isfile(folderName .. "/theme.json") then
        ...
        title = (userThemeData.Title == "Insight.win" and "Insight.win") or userThemeData.Title
        Insight.win.theme = {
    ...
    local menu = Insight.win:CreateMenu(title or defaultUIName, (not cacheExists) or devMode or uiCache.open, cacheExists and uiCache.index or 1)
    Insight.win.GetValue = menu.GetValue
    Insight.win.sectionIndexes = menu.sectionIndexes
